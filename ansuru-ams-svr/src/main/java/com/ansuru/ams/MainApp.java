...
//        System.out.println("assets = " + assets);
        UserAdminService userAdminService =  app.getBean(UserAdminService.class,"userAdminService");
        ResponseSvrUserAdminFind byUserName = userAdminService.findByUserName(new RequestSvrUserAdminFind());
